...
# parser.add_argument('--kitti15_datapath', default='/media/cihci/0000678400004823/andy_master/code/ACVNet/data/data_stereo_flow/', help='data path')
# parser.add_argument('--kitti12_datapath', default='/media/cihci/0000678400004823/andy_master/code/ACVNet/data/data_stereo_flow/', help='data path')

parser.add_argument('--kitti15_datapath', default='/media/cihci/0000678400004823/andy_master/code/ACVNet/', help='data path')
parser.add_argument('--kitti12_datapath', default='/media/cihci/0000678400004823/andy_master/code/ACVNet/', help='data path')
...
parser.add_argument('--trainlist', default='./filenames/train_192_20220707.txt', help='training list')
parser.add_argument('--testlist',default='./filenames/test_192_20220707.txt', help='testing list')
# parser.add_argument('--trainlist', default='./filenames/kitti12_train.txt', help='training list')
...
parser.add_argument('--logdir',default='./checkpoints/20220707/', help='the directory to save logs and checkpoints')
...
parser.add_argument('--summary_freq', type=int, default=587, help='the frequency of saving summary')
