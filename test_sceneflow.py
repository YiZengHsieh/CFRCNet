...
parser.add_argument('--datapath', default='/media/cihci/0000678400004823/andy_master/code/ACVNet/', help='data path')
# parser.add_argument('--testlist',default='./filenames/test_192_one.txt', help='testing list')
parser.add_argument('--testlist',default='./filenames/kitti15_test_one.txt', help='testing list')
...
# parser.add_argument('--loadckpt', default='./pretrained_model/checkpoint_000100.ckpt',help='load the weights from a specific checkpoint')
